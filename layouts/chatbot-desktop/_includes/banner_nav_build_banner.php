...
<?php elseif($page && substr($page,0,5) =='build'):?>
   <?php $banner_img ='chatbotboy.png';?>
    <section id="cb-chatbot-banner">
        <div class="cb-chatbot-banner-wrapper">
            <img src="<?php echo $g['img_layout'].'/'.$banner_img?>" alt="chatbot" />
        </div>
    </section>
<?php endif?>
