// Version 1.9.1 sunburst-chart - https://github.com/vasturiano/sunburst-chart
  ...
  var sunburst = index({
    ...
    update: function update(state) {
      ...
      var newSlice = slice.enter().append('g').attr('class', 'slice').style('opacity', 0).on('click', function (d) {
        ...
        // aramjo modify
        var clickFlow = [];
        var flow = getNodeStack(d).slice(state.excludeRoot ? 1 : 0).map(function (d) {
          clickFlow.push({'name':d.data.name, 'nodeid':d.data.nodeid});
        });
        (_this2.focusOnNode)(d.data);
        (state.onClick)(clickFlow);
        //-------------------------------
