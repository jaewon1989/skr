...
$menu_icon = array(
    ...
    "legacy"=>"fa-database",
    "link"=>"fa-link",
    "monitering"=>"fa-desktop",
    "operation"=>"fa-check-square-o",
    "smanager"=>"fa-group",
    "skin"=>"fa-commenting-o",
    "intro"=>"fa-street-view",
    "statis"=>"fa-line-chart",
    "gathering"=>"fa-language",
    "convstat"=>"fa-commenting",
    "convanalysis"=>"fa-pie-chart",
    "convflow"=>"fa-area-chart",
    "convtest"=>"fa-random",
    "faq"=>"fa-question-circle",
    "statgpt"=>"fa-object-group",
    "mem"=>"fa-group",
    "membergroup"=>"fa-address-book",
    "memberperm"=>"fa-user-lock",
    "memberadd"=>"fa-user-plus",
);
...
$pageTitle = $chatbot->getRoleTypeName($pageTitle);
$pageTitle = ('call' === $getListBot['bottype'] ? '콜봇 관리 / ' : '챗봇 관리 / ') . $pageTitle;
...
// 회원관리
if(strpos($page, 'adm/member') !== false) $_member = true;
else $_member = false;
