...
<div class="rb-root">
	<div id="rb-login">
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color:none;background:url(/layouts/rc-instar/_images/bg_bar.png);">
				<h1 class="panel-title">
					<a href="<?php echo $g['r']?>/">
					   <img src="/layouts/rc-instar/_images/logo.png" style="width: 30%;height:auto;" />
					</a>
					<small style="color:#fff;"> 관리자 로그인</small>
					<!-- <a href="<?php echo $g['r']?>/"><i class="kf-bi-01"></i></a> <small>Admin Mode</small> -->
				</h1>
			</div>
