...
include_once $g['path_module'].'chatbot/var/var.php';
$from_email='admin@ceo4.co.kr';
$from_name='보톡스';
$to_name='관리자';
$to_email_arr =explode(',',$d['chatbot']['rsv_email']);
$_title='[보톡스] 사용자의 참여/제보 및 문의메일이 접수되었습니다.'; 
...
if($backtype=='ajax'){
	...
	$return['error'] = false;
	$return['result'] ='OK';
	$return['email'] = $d['chatbot']['rsv_email'];
