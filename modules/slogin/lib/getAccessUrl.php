...
function getAccessUrl($s,$id,$secret,$callBack,$type)
{
...
// 대상 모듈별 slogin 값 담기
$targetModule = 'slogin';
$accessUrl['naver'] = getAccessUrl('naver',$d['slogin']['key_n'],$d['slogin']['secret_n'],$g['url_root'].'/?r='.$r.'&m='.$targetModule.'&a=slogin&sloginReturn=naver',false);
$accessUrl['kakao'] = getAccessUrl('kakao',$d['slogin']['key_k'],$d['slogin']['secret_k'],$g['url_root'].'/?r='.$r.'&m='.$targetModule.'&a=slogin&sloginReturn=kakao',false);
$accessUrl['facebook'] = getAccessUrl('facebook',$d['slogin']['key_f'],$d['slogin']['secret_f'],$g['url_root'].'/?r='.$r.'&m='.$targetModule.'&a=slogin&sloginReturn=facebook',false);
$accessUrl['google'] = getAccessUrl('google',$d['slogin']['key_g'],$d['slogin']['secret_g'],$g['url_root'].'/?r='.$r.'&m='.$targetModule.'&a=slogin&sloginReturn=google',false);
$accessUrl['instagram'] = getAccessUrl('instagram',$d['slogin']['key_i'],$d['slogin']['secret_i'],$g['url_root'].'/?r='.$r.'&m='.$targetModule.'&a=slogin&sloginReturn=instagram',false);
$accessUrl['twitter'] = getAccessUrl('twitter',$d['slogin']['key_t'],$d['slogin']['secret_t'],$g['url_root'].'/?r='.$r.'&m='.$targetModule.'&a=slogin&sloginReturn=twitter',false);
