...
{  
	...
	if ($s == 'facebook')
	{
		...
		if ($type == 'token')
		{
            ...
            {
	            $_tmp = json_decode(getCURLData($g['slogin']['callurl']));
...
if ($_GET['sloginReturn'] == 'naver')
{
	socialLogin($_GET['sloginReturn'],$d['slogin']['key_n'],$d['slogin']['secret_n'],$g['url_root'].'/?r='.$r.'&m='.$m.'&a=slogin&sloginReturn=naver','token');
}
if ($_GET['sloginReturn'] == 'kakao')
{
	socialLogin($_GET['sloginReturn'],$d['slogin']['key_k'],$d['slogin']['secret_k'],$g['url_root'].'/?r='.$r.'&m='.$m.'&a=slogin&sloginReturn=kakao','token');
}
if ($_GET['sloginReturn'] == 'facebook')
{
	socialLogin($_GET['sloginReturn'],$d['slogin']['key_f'],$d['slogin']['secret_f'],$g['url_root'].'/?r='.$r.'&m='.$m.'&a=slogin&sloginReturn=facebook','token');
}
if ($_GET['sloginReturn'] == 'google')
{
	socialLogin($_GET['sloginReturn'],$d['slogin']['key_g'],$d['slogin']['secret_g'],$g['url_root'].'/?r='.$r.'&m='.$m.'&a=slogin&sloginReturn=google','token');
}
if ($_GET['sloginReturn'] == 'instagram')
{
	socialLogin($_GET['sloginReturn'],$d['slogin']['key_i'],$d['slogin']['secret_i'],$g['url_root'].'/?r='.$r.'&m='.$m.'&a=slogin&sloginReturn=instagram','token');
}
if ($_GET['sloginReturn'] == 'twitter')
{
	socialLogin($_GET['sloginReturn'],$d['slogin']['key_t'],$d['slogin']['secret_t'],$g['url_root'].'/?r='.$r.'&m='.$m.'&a=slogin&sloginReturn=twitter','token');
}
?>