...
<audio id="myAudio">
  <source src="/files/01.ogg" type="audio/ogg">
  <source src="/files/01.mp3" type="audio/mpeg">
            ...
            <div class="white-box">
                ...
                <div class="form-horizontal form-material">
                    <div class="form-group btn-block btn-outline btn-info" style="padding: 10px 12px;">
                        <span>아래 파일을 선택한 후 [텍스트 변환] 버튼을 클릭해주세요.</span>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <div class="col-md-2">
                            <button class="btn btn-block btn-outline btn-rounded btn-info" id="start-rts">
