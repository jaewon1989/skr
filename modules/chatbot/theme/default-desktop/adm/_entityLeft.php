...
<div class="form-group panel-search" style="margin-bottom:10px;">
    <div class="input-group">
        <input type="text" class="form-control" placeholder="<?php echo $callEntity?>명을 입력해주세요" data-role="ie-search" data-type="entity">
        <span class="input-group-addon" data-role="btn-ie-search" data-type="entity"><i class="fa fa-search"></i></span>
    </div>
</div>
