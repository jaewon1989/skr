...
<script type="text/javascript">
	...
	var defaultXml = '<mxGraphModel><root><mxCell id="0"/><mxCell id="1" parent="0"/><mxCell id="2" value="대화주제" uid="1" parent="0" vertex="1"><mxGeometry y="35" width="110" height="40" as="geometry"/></mxCell></root></mxGraphModel>';
...
<div id="dialog-workspace" style="padding-left:20px;">

	<div id="header">

		<div id="headerTitle">
			<h1 id="title" style="">대화 관리</h1>
		</div>	
		<ul id="headerBtnBox">
			<li data-role="change-panelMod" data-type="graph">
				<button type="button" class="btn btn-primary" data-tooltip="tooltip" title="대화상자 편집" >대화그래프</button>
			</li>
			<li data-role="change-panelMod" data-type="intent">
				<button type="button" class="btn btn-default" data-tooltip="tooltip" title="문장에 포함된 사용자 인텐트" ><?php echo $callIntent?></button>
			</li>
			<li data-role="change-panelMod" data-type="entity">
				<button type="button" class="btn btn-default" data-tooltip="tooltip" title="인텐트와 관련된 핵심 엔터티" ><?php echo $callEntity?></button>
			</li>
			<li data-role="change-panelMod" data-type="data">
				<button type="button" class="btn btn-default" data-tooltip="tooltip" title="데이타셋" >데이타셋</button>
			</li>
