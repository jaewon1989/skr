...
$g_avatar = _changeBotNaming($chatbot->getGuideTxt($_tmp,'avatar'), $getAdBot['bottype']);
$g_name = _changeBotNaming($chatbot->getGuideTxt($_tmp,'name'), $getAdBot['bottype']);
$g_needName = _changeBotNaming($chatbot->getGuideTxt($_tmp,'needName'), $getAdBot['bottype']);
$g_service = $chatbot->getGuideTxt($_tmp,'service');
$g_intro = _changeBotNaming($chatbot->getGuideTxt($_tmp,'intro'), $getAdBot['bottype']);
$g_error_msg = _changeBotNaming($chatbot->getGuideTxt($_tmp,'errorMsg'), $getAdBot['bottype']);
$g_timeout = _changeBotNaming($chatbot->getGuideTxt($_tmp,'timeout'), $getAdBot['bottype']);
$g_timeout_msg = _changeBotNaming($chatbot->getGuideTxt($_tmp,'timeoutMsg'), $getAdBot['bottype']);
$g_webUrl = _changeBotNaming($chatbot->getGuideTxt($_tmp,'webUrl'), $getAdBot['bottype']);
$g_botUrl = _changeBotNaming($chatbot->getGuideTxt($_tmp,'botUrl'), $getAdBot['bottype']);
$g_callNo = $chatbot->getGuideTxt($_tmp,'callNo');
$g_wave = $chatbot->getGuideTxt($_tmp,'wave');
$g_pitch = $chatbot->getGuideTxt($_tmp,'pitch');
$g_speed = $chatbot->getGuideTxt($_tmp,'speed');
...
<link href="/_core/css/audioplayer.css" rel="stylesheet" xmlns="http://www.w3.org/1999/html">
...
<!--         <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> <a href="http://wrappixel.com/templates/pixeladmin/" target="_blank" class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Upgrade to Pro</a>
    ...
    -->
    <div class="overview">
        <div class="page-title">기본설정</div>
        <div class="sub-frame">
            <div class="sub-title">SK telecom AICC / <?=$pageTitle?></div>
        </div>
    </div>
    <?=$g_common?>
    <!-- row -->
            ...
            <div class="white-box">
                <form class="form-horizontal form-material" autocomplete="off" data-role="configBotForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1"><label>아바타<?=$g_avatar?></label></div>
                        <div class="col-md-11" style="display:flex;">
                            <?=$getAdBot['bot_avatar_img']?>
                            <div class="bot_avatar_description_area">
                                <span class="bot_avatar_description">(변경 시 이미지 클릭)</span>
                                <span class="bot_avatar_description">(파일 용량 제한: 2MB 이하), (등록 가능 이미지 포맷 : JPG, GIF, PNG)</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-1"><label class="input"><?='call' === $getAdBot['bottype'] ? '콜봇명' : '챗봇명'?><?=$g_name?></label></div>

                        <div class="col-md-11">
                            <input type="text" name="name" value="<?=$getAdBot['name']?>"  class="form-control form-control-line" data-role="enter-text" data-type="length" data-limit="15">
                    ...
                    <div class="form-group">
                        <div class="col-md-1"><label class="input">홈페이지<?=$g_webUrl?></label></div>
                        <div class="col-md-11">
                            <input type="text" placeholder="http://www.bottalks.co.kr" class="form-control form-control-line" name="website" value="<?=$getAdBot['website']?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-1"><label class="input"><?='call' === $getAdBot['bottype'] ? '콜봇 URL' : '챗봇 URL'?><?=$g_botUrl?></label></div>
                        <div class="col-md-11">
                            <span id="bot_url"><?=$getAdBot['bot_url']?></span>
                    ...
                    <?if($getAdBot['bottype'] == 'call'){?>
                    <div class="form-group">
                        <div class="col-md-1"><label class="input"><?=$chatbot->getRoleTypeName('챗봇')?> 번호<?=$g_callNo?></label></div>
                        <div class="col-md-11" style="padding-top:8px;">
                            <input type="text" placeholder="전화번호" class="form-control form-control-line" name="callno" value="<?=$callno?>" style="width:200px;">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-1"><label class="input">봇ID</label></div>
                        <div class="col-md-11" style="padding-top:8px;">
                            <?=$getAdBot['botId']?>
                        </div>
                    </div>
                    <?}?>
                    <div class="form-group">
                        <div class="col-md-1"><label class="input">업종</label></div>
                        <div class="col-md-11" style="padding-top:8px;">
                            <?=$upjong?>
                    ...
                    <div class="form-group">
                        <div class="col-md-1"><label class="input">서비스명<?=$g_service?></label></div>
                        <div class="col-md-11">
                            <input type="text" placeholder="서비스명" name="service" value="<?=$getAdBot['service']?>" class="form-control form-control-line" >
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-1"><label>소개<?=$g_intro?></label></div>
                        <div class="col-md-11">
                            <textarea rows="5" name="intro" class="form-control form-control-line"><?=$getAdBot['intro']?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-1" style="width:auto;"><label>오류 안내 메시지<?=$g_error_msg?></label></div>
                        <div class="col-md-10">
                                <textarea rows="5" name="error_msg"
                                          class="form-control form-control-line"><?=str_replace("<br>","\r\n",$getAdBot['error_msg'])?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-1" style="width:auto;"><label>세션 종료 시간<?=$g_timeout?></label></div>
                        <div class="col-md-10">
                            <div class="input-group" style="width:200px;">
                                <input type="text" name="timeout" value="<?=$getAdBot['timeout']?>"  class="form-control form-control-line" data-role="enter-text" data-type="length" data-limit="5">
                                <span class="input-group-addon"> 초</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-1" style="width:auto;"><label>세션 종료 메시지<?=$g_timeout_msg?></label></div>
                        <div class="col-md-10">
                                <textarea rows="5" name="timeout_msg"
                                          class="form-control form-control-line"><?=str_replace("<br>","\r\n",$getAdBot['timeout_msg'])?></textarea>
                        </div>
                    </div>
                    ...
                    ?>
                    <div class="form-group">
                        <div class="col-md-1"><label class="input">음성선택<?=$g_wave?></label></div>
                        <div class="col-md-11">
                            <div>
                    ...
                    <div class="form-group">
                        <div class="col-md-1"><label class="input">들어보기</label></div>
                        <div class="col-md-11">
                    ...
                    <div class="form-group tts_pitch_wrap">
                        <div class="col-md-1"><label class="input">음역선택<?=$g_pitch?></label></div>
                        <div class="col-md-11">
                    ...
                    <div class="form-group tts_speed_wrap">
                        <div class="col-md-1"><label class="input">속도선택<?=$g_speed?></label></div>
                        <div class="col-md-11">
                            <div class="slider-wrapper" style="width:250px;">
