            ...
            <div class="respondGrop">
                <ul id="respondGroup-tab" class="nav nav-tabs">
                    <li class="active item">
                       ...
                       <a href="#1" data-toggle="tab">첫번째</a>
                    </li>
                    <li class="item">
                        <input type="hidden" name="respondGroup_index[]" value="1">
                        <a href="#2" data-toggle="tab">두번째</a>
                    </li>
                    <li class="item">
                        <input type="hidden" name="respondGroup_index[]" value="2">
                        <a href="#3" data-toggle="tab">세번째</a>
                    </li>
                </ul>
...
<script>
var setSortable_respondGroup = function(){
