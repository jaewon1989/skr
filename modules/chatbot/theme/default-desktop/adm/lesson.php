                        ...
                        <div class="panel-collapse collapse in" id="collapmetane">                                
                            <div class="panel-body">
                                <div style="height:400px;overflow:auto;">
                                    ...
                                    <?php $_treeOptions['add_where'] = "type=2"?> <!-- type = 1 : 과정, type = : 학과 -->
                                    ...
                                    <?php if($cat):?>
                                       <ol class="breadcrumb" style="padding:10px 15px">
                                           <?php for ($i = 0; $i < $ctnum-1; $i++):?>
                                            ...
                                            <?php if(!$delparent):?>학과 등록정보<?php endif?>
                                        </ol>
                                    <?php endif?>
                            <?php endif?>
                        <?php endif?>
                        ...
                        <div class="col-md-11">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <?php if($now_depth<2):?>
                                    <!-- <a href="<?php echo $base_url?>&amp;cat=<?php echo $cat?>&amp;vtype=sub" class="btn btn-default" data-tooltip="tooltip" title="학과 등록">
