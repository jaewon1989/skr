...
<link href="/_core/css/notifyr.css" rel="stylesheet">
<script src="/_core/js/notifyr.js"></script>
<!-- 클립보드 복사용 타겟 -->
...
<div class="container-fluid" id="page-monitering">
    ...
    -->
    <div class="overview">
        <div class="page-title">모니터링 : <span class="tit-url"><?php echo $getAdBot['bot_url']?> <?=($getAdBot['bottype'] == "call" ? "(".$getAdBot['callno'].")" : "")?></span></div>
        <div class="sub-frame">
    ...
    <div class="row">
        <div class="monitering_wrap">
             <?php if($use_chatting =='on'):?>
            <div class="col-md-3">
                <div class="white-box table-container table-aicc-skin" id="liveBot-list">
                    <table class="table table-striped table-full" id="tbl-intentSet" data-role="tbl-intentSet" style="margin-bottom: 0;">
                        <thead>
                    ...
                    <div data-role="table-scroll" class="table-scroll">
                        ...
                        <div class="moniteringPage-guide botList-guide" data-role="botListWrapper-guide">
                              <i class="fa fa-info-circle fa-lg"></i> 사용자가 콜/챗봇 접속시 리스트가 출력됩니다.
                        </div>
                    </div>
            ...
            <div class="col-md-5">
                <div class="white-box auto-box" >
                    ...
                    <div class="moniteringPage-guide chatBox-guide" data-role="chatbotWrapper-guide">
                          <i class="fa fa-info-circle fa-lg"></i> 좌측 콜/챗봇 리스트를 클릭해주세요.
                    </div>
                </div>
            </div>
            <div class="col-md-4" style="display:<?=($getAdBot['bottype']=='call' ? 'none;' : '')?>">
