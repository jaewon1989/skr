...
<div id="dialog-workspace" style="padding-left:20px;">
    ...
    <div id="intentPanel" data-role="intentPanel" class="intentPanel">
     	<div id="intentPanel-left" data-role="intentPanel-left">
    	     <?php include($g['dir_module_skin'].'vendor/_intentLeft.php');?>
    	</div> 
    	<div id="intentPanel-right" data-role="intentPanel-right">
