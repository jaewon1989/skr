...
<div class="container-fluid">
    ...
    -->
    <div class="overview">
        <div class="page-title">대화 분석</div>
        <div class="sub-frame">
...
<script>
    ...
    // 그래프 그리기
    const color = d3.scaleOrdinal(d3.schemeSet2); //schemePaired, schemeCategory10, schemeTableau10, schemeAccent, schemeDark2, schemeSet1, schemeSet2, schemeSet3
    ...
    function getBoxHeight() {
        ...
        $(".sunburst-viz svg").css("height", ($(window).height() - 305)+"px")
        $(".sunburst-viz svg").css("width", ($(window).width() - 900)+"px")
    }
