	...
	<div id="header">
		...
		<ul id="headerBtnBox" class="graph-headerBtn" data-role="graph-headerBtn">
			...
			<li data-role="change-panelMod" data-type="intent">
				<button type="button" id="btn-intent" class="btn btn-default waves-effect" data-tooltip="tooltip" title="문장에 포함된 사용자 의도" ><?php echo $callIntent?></button>
			</li>
			<li data-role="change-panelMod" data-type="entity">
				<button type="button" id="btn-entity" class="btn btn-default waves-effect" data-tooltip="tooltip" title="의도와 관련된 핵심 엔터티" ><?php echo $callEntity?></button>
			</li>
			<li data-role="change-panelMod" data-type="learning">
			    <button type="button" id="btn-learning-intent" class="btn btn-default waves-effect" data-tooltip="tooltip" title="의도학습" >의도 학습 <i class="fa fa-share-alt"></i></button>
			</li>
