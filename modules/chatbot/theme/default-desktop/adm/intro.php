...
<div class="container-fluid">
    ...
    -->
    <div class="overview">
        <div class="page-title">인트로 설정</div>
        <div class="sub-frame">
            ...
            <div class="white-box">
                <form class="form-horizontal form-material" autocomplete="off" data-role="configBotForm">
                    ...
                    <div class="form-group">
                        <div class="col-md-1"><label>인트로 화면</label></div>
                        <div class="col-md-11">
                    ...
                    <div class="form-group">
                        <div class="col-md-1"><label>인트로 인사말</label></div>
                        <div class="col-md-11">
                             <div class="radio-list">
                                <textarea name="intro_greeting" class="form-control i_intro" data-role="enter-text" data-type="length" data-limit="35" maxlength="35"><?=$getBotIntro['intro_greeting']?></textarea>
                            </div>
                            <div class="small">
                    ...
                    <div class="form-group">
                        <div class="col-md-1"><label>인트로 부인사말</label></div>
                        <div class="col-md-11">
                             <div class="radio-list">
                                <textarea name="intro_sub_greeting" class="form-control i_intro" data-role="enter-text" data-type="length" data-limit="60" maxlength="60"><?=$getBotIntro['intro_sub_greeting']?></textarea>
                            </div>
                            <div class="small">
                    ...
                    <div class="form-group">
                        <div class="col-md-1"><label>프로필 이미지</label></div>
                        <div class="col-md-11">
                             <div class="radio-list">
                    ...
                    <div class="form-group">
                        <div class="col-md-1"><label>메뉴 연동</label></div>
                        <div class="col-md-11">
                             <div class="radio-list">
                                <label class="radio-inline i_intro" style="padding-top:0;">
                    ...
                    <div class="form-group">
                        <div class="col-md-1"><label>하단 로고 설정</label></div>
                        <div class="col-md-11">
                             <div class="radio-list">
                                <label class="radio-inline i_intro" style="padding-top:0;">
                    ...
                    <div class="form-group">
                        <div class="col-md-1"><label>채널 설정</label></div>
                        <div class="col-md-11">
                             <div class="radio-list">
                                <label class="radio-inline i_intro" style="padding-top:0;">
