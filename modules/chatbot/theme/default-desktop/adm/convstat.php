...
<div class="container-fluid">
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">통계/분석 > 대화</h4>
        </div>
    </div>
    -->
    <div class="overview">
        <div class="page-title">대화 현황</div>
        <div class="sub-frame">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                ...
                <div id="conversation-wrap" style="height: 40vh;">
                   <!-- load 접속통계 차트 -->       
                </div>
            </div>
        </div>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">전체 세션</th>
                                    <th style="text-align: center;">전체 대화</th>
                                    <th style="text-align: center;">인당 대화 수</th>
