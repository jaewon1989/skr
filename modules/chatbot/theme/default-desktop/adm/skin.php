            ...
            <div class="white-box">
                <form class="form-horizontal form-material" autocomplete="off" data-role="configBotForm">
                         ...
                         <div class="text-muted" style="margin:0 0 10px 10px;">
                          임베딩 챗봇 사용 시에 사용되는 챗봇 버튼 아이콘을 등록하실 수 있습니다.
                            ...
                            <div class="col-md-11" style="display:flex;">
                                ...
                                <span class="botAvatar-wrapper" data-role="self-uploadImg" style="background-image: url(<?=$getAdBot['chatBtn']?>);width:45px;height:45px;position:relative;">
                                    <span class="botAvatar-wrapper btn_reset_botAvatar"
                                          data-role="reset_botAvatar" <?php if ("/_core/skin/images/btn_chatbot.png" === $getAdBot['chatBtn']) echo 'style="display:none;"'; ?>></span>
                                </span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                        	<div class="text-muted" style="margin:0 0 10px 10px;">
                        		다양한 채팅창 스킨과 함께 SK telecom AICC 에서 제공하는 직접접속 URL 또는 임베드 스크립트로 챗봇을 사용하실 수 있습니다.
                        	</div>
                            <div class="row show-grid text-center" style="margin-top:0;">
                            	<?foreach($aSkin as $key=>$aData) {?>
                            	<div class="col-md-3 skin_box_outer <?=($chatSkin!=$aData['cssFile']?"notselect":"skin_selected")?>" skin="<?=$aData['cssName']?>">
