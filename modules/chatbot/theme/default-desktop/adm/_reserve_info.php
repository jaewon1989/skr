                    ...
                    <div class="col-in row">
                        <div class="table-responsive" style="min-height:400px;">
                            <table class="table table-striped">
                                <?if($my['cgroup'] == "kblife") {?>
                                <tr>
                                    <th style="width:8%;border-top:1px solid #333;text-align:center;">구분</th>
                                    <th style="width:10%;border-top:1px solid #333;text-align:center;">이름</th>
                                    <th style="width:12%;border-top:1px solid #333;text-align:center;">휴대폰</th>
                                    <th style="width:15%;border-top:1px solid #333;text-align:center;">이메일</th>
                                    <th style="width:10%;border-top:1px solid #333;text-align:center;">생년월일</th>
                                    <th style="width:10%;border-top:1px solid #333;text-align:center;">지역</th>
                                    ...
                                    <th style="border-top:1px solid #333;text-align:center;">상세정보</th>
                                </tr>
                                <?} else {?>
                                <tr>
                                    <th style="width:20%;border-top:1px solid #333;text-align:center;">사용자</th>
                                    <th style="width:20%;border-top:1px solid #333;text-align:center;">등록일</th>
                                    <th style="width:20%;border-top:1px solid #333;text-align:center;">예약자명</th>
                                    <th style="width:10%;border-top:1px solid #333;text-align:center;">연락처</th>
                                    <th style="width:20%;border-top:1px solid #333;text-align:center;">상담예약시간</th>
                                    <th style="width:10%;border-top:1px solid #333;text-align:center;">상담여부</th>
                                </tr>
                                <?}?>
...
<script type="text/javascript">
    ...
    $(document).on("change", ".s_status", function() {
        ...
        if(uid) {
            $.post(rooturl+'/?r='+raccount+'&m='+module+'&a=get_ReserveChart',{
                linkType : 'status',
                vendor : vendor,
                botuid : botuid,
                uid : uid,
