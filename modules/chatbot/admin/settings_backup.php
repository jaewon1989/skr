...
<form class="form-horizontal rb-form" role="form" name="procForm" action="<?php echo $g['s']?>/" method="post" target="_action_frame_<?php echo $m?>" onsubmit="return saveCheck(this);">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">챗봇 레이아웃(D) <small class="text-muted"><a data-toggle="collapse" data-tooltip="tooltip" title="도움말" href="#layout_main-guide"><i class="fa fa-question-circle fa-fw"></i></a></small></label>
		<div class="col-sm-10">
			...
			<p class="help-block collapse" id="layout_main-guide">
				<small>
				챗봇 대표레이아웃(<code>데스크탑 전용</code>) 을 선택해주세요.<br />
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">챗봇 레이아웃(M) <small class="text-muted"><a data-toggle="collapse" data-tooltip="tooltip" title="도움말" href="#layout_mobile-guide"><i class="fa fa-question-circle fa-fw"></i></a></small></label>
		<div class="col-sm-10">
			...
			<p class="help-block collapse" id="layout_mobile-guide">
				<small>
				챗봇 대표레이아웃(<code>모바일 전용</code>) 을 선택해주세요.<br />
    ...
    <div class="form-group">
	    ...
	    <div class="col-sm-10">
              <input name="upjong" class="form-control" value="<?php echo $d['chatbot']['upjong']?>" placeholder="콤마로 구분해서 입력" />
        </div>
    </div>
    <?php $day_array=array("월"=>"mon","화"=>"tue","수"=>"wed","목"=>"thu","금"=>"fri","토"=>"sat","일"=>"sun");?>
    <?php foreach ($day_array as $kday=>$eday):?>
    <div class="form-group">
        <label class="col-sm-2 control-label"><?php echo $kday?>요일 인사말</label>
	    <div class="col-sm-10">
            <p>
            	<input name="<?php echo $eday?>_hello" class="form-control" value="<?php echo $d['chatbot'][$eday.'_hello']?>" placeholder="<?php echo $kday?>요일 인사말" />
 			</p>
        </div>
    </div>	
    <?php endforeach?>
