...
if($uid)
{
	$R = getUidData($table[$module.'question'],$uid);
...
<div class="row">
   <div class="col-sm-4 col-lg-3"> 
   	    <div class="panel panel-default">  <!-- 메뉴 리스트 패털 시작 -->
			...
			<div id="panel-search" class="collapse<?php if($_SESSION['sh_ad_member_search']):?> in<?php endif?>">
				...
				<input type="hidden" name="front" value="addQuestion">
			...
			<div class="panel-body" style="border-top:1px solid #DEDEDE;height:100%;overflow:auto;">
				...
				<div class="list-group" id="addReply-mlist">
					...
					<a href="#" class="list-group-item" data-act="sel-vendor" data-uid="<?php echo $M['uid']?>" data-info="<?php echo $M['name']?>(<?php echo $M['id']?>)" >
   ...
   <div id="tab-content-view" class="col-sm-8 col-lg-9">
		...
		<input type="hidden" name="a" value="_admin/add_question" />
        ...
        <?php include $g['path_module'].$module.'/admin/_add_question.php';?>
	
		<div class="form-group">
			<div class="col-sm-12">
				<button type="submit" class="btn btn-primary btn-block btn-lg"><i class="fa fa-check fa-lg"></i> 질문<?php echo $R['uid']?'수정하기':'등록하기'?></button>
			</div>
		</div>
