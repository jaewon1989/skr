...
namespace Guzzle7Http;

use Guzzle7Http\Exception\InvalidArgumentException;
use Guzzle7Http\Handler\CurlHandler;
use Guzzle7Http\Handler\CurlMultiHandler;
use Guzzle7Http\Handler\Proxy;
use Guzzle7Http\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \Guzzle7Http\Psr7\Utils::tryFopen('php://output', 'w');
    }
    ...
    {
        return sprintf('Guzzle7Http/%d', ClientInterface::MAJOR_VERSION);
    }
