...
if ($uid)
{
	...
	$QVAL = "name='$name',service='$service',intro='$intro',induCat='$induCat',logo='$logo',upload='$upload'";
...
{	    
	...
	$gid = $mingid ? $mingid-1 : 1000000000;
 	$QKEY = "auth,gid,display,hidden,type,mbruid,induCat,id,name,service,intro,logo,upload,d_regis";
 	$QVAL = "'$auth','$gid','$display','$hidden','$type','$mbruid','$induCat','$id','$name','$service','$intro','$logo','$upload','$d_regis'";
...
$next_link = $g['s'].'/?r='.$r.'&m='.$m.'&page=build/step2&vendor='.$NOWUID;
