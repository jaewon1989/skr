...
if ($cat && !$vtype)
{
	...
	$QVAL.= "layout='$layout',skin='$skin',skin_mobile='$skin_mobile',imghead='$imghead',imgfoot='$imgfoot',puthead='$puthead',putfoot='$putfoot',recnum='$recnum',sosokmenu='$sosokmenu',review='$review',tags='$tags',featured_img='$featured_img',rp_sentence='$rp_sentence'";
	...
	for ($i = 0 ; $i < $slen; $i++)
	{
		...
		$puthead=$imghead?1:0;
		$putfoot=$imgfoot?1:0;
		$QKEY = "gid,isson,parent,depth,hidden,reject,name,layout,skin,skin_mobile,imghead,imgfoot,puthead,putfoot,recnum,num,sosokmenu,review,tags,featured_img,rp_sentence";
		$QVAL = "'$gid','0','$parent','$xdepth','$hidden','$reject','$xname','$layout','$skin','$skin_mobile','$imghead','$imgfoot','$puthead','$putfoot','$recnum','0','$sosokmenu','$review','$tags','$featured_img','$rp_sentence'";
