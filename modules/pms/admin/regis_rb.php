	      ...
	      <div id="tab-content-view" class="col-sm-8 col-lg-9">
	      	<div class="rb-content-padded">
	      		 <ul class="nav nav-tabs" role="tablist">
	      		 	...
	      		 	<li<?php if($_COOKIE['regisTap']=='price'):?> class="active"<?php endif?>><a href="#price-settings" role="tab" data-toggle="tab" onclick="_cookieSetting('regisTap','price');">가격정보</a></li>
	      		 	<li<?php if($_COOKIE['regisTap']=='display'):?> class="active"<?php endif?>><a href="#display-settings" role="tab" data-toggle="tab" onclick="_cookieSetting('regisTap','display');">전시정보</a></li>
			           ...
			           <li<?php if($_COOKIE['regisTap']=='joint'):?> class="active"<?php endif?>><a href="#joint-settings" role="tab" data-toggle="tab" onclick="_cookieSetting('regisTap','joint');">관련상품</a></li>
		</ul>
			     <div class="tab-content" id="textarea-wrapper">
	                       ...
	                       <div class="tab-pane<?php if($_COOKIE['regisTap']=='price'):?> active<?php endif?>" id="price-settings">
				             <?php include $g['path_module'].$module.'/admin/_regis_price.php';?>
	                       </div>
	                        <div class="tab-pane<?php if($_COOKIE['regisTap']=='display'):?> active<?php endif?>" id="display-settings">
				             <?php include $g['path_module'].$module.'/admin/_regis_display.php';?>
	                       </div>
	                       ...
	                       <div class="tab-pane<?php if($_COOKIE['regisTap']=='joint'):?> active<?php endif?>" id="joint-settings">
