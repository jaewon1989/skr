...
.rb-catalog-list .content,
.rb-catalog-view .content {
    background-image: url('./image/content-bg-.png');
}

</style>
<?php include_once $g['dir_module_skin'].'main.func.php';?>
    ...
    <div class="page center" id="page-catalog-list">
        <div class="rb-catalog-list">
            <header class="bar bar-nav">
                ...
                <h1 class="title" data-role="catName"><?php echo $C['name']?></h1>
            </header>
            <div class="content" data-role="content" id="swipper-parent"> 
                  <?php echo Shop_theme_getProductList($cat,$sort,$orderby,$recnum,$_WHERE)?>
            </div>
        </div>
    </div>
    <div class="page right" id="page-catalog-view" >
        <div class="rb-catalog-view">
            ...
            <div class="bar bar-standard bar-footer rb-buttons">
                <div class="row">
                    <div class="col-xs-6">
                        <a href="#" data-toggle="page" data-start="#page-catalog-view" data-target="#page-catalog-contact2" data-title="'" data-url="" data-id="" data-role="event-handler" class="btn btn-primary btn-block">가입신청</a>
                    </div>
                    <div class="col-xs-6">
