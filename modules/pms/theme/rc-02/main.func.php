                     ...
                     $list.='
                           <div class="swiper-slide">
                                <section class="rb-buttons content-padded">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <a href="#" data-toggle="page" data-start="#page-catalog-list" data-target="#page-catalog-contact" data-title="'.$R['name'].'" data-etc="'.$data_etc.'" data-url="/catalog/product/'.$R['uid'].'/contact" data-id="'.$R['uid'].'" class="btn btn-primary btn-block">가입신청</a>
                                        </div>
                                        <div class="col-xs-6">
                                ...
                                <section class="rb-cover">
                                    <div class="card">
                                        ...
                                        <div class="card-img-backdrop"></div>
                                ...
                                <section class="content-padded">
                                    <a href="#" data-toggle="page" data-start="#page-catalog-list" data-target="#page-catalog-view" data-title="'.$R['name'].'" data-etc="'.$data_etc.'" data-url="/catalog/product/'.$R['uid'].'" 
                                        data-theme="'.$g['path_module'].$m.'/theme/rc-01/" 
                                        data-themeurl="/modules/catalog/theme/rc-01" 
                                        data-module="'.$m.'" 
                                        data-content="catalog-view"
                                        data-actionfile="get_ProductContent"
                                        data-id="'.$R['uid'].'" class="btn btn-positive btn-block">상품 상세보기</a>
                                </section>
                            </div>';
             }
                 $list.=' 
