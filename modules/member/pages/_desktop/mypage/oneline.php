	   		 ...
	   		 <label class="col-sm-1 control-label">필터</label>
				 <div class="col-sm-11">	
					  <div class="col-sm-9">
						...
						<div class="col-sm-2">
							<button type="button" class="btn btn-link" data-toggle="collapse" data-target="#search-more-bbs" onclick="sessionSetting2('my_oneline','1','','1');"><small>엔터티 검색</small></button>
						</div>
				 </div> <!-- .col-sm-11 -->	 
			 </div><!-- .form-group -->	 
