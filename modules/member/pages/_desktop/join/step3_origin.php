		...
		<div class="col-sm-12">
			<div class="panel panel-default">
			    <div class="panel-heading">
			        <h4 class="panel-title">가입 양식 <small class="pull-right"><span class="text-danger">*</span> 표시가 있는 항목은 반드시 입력해야 합니다.</small></h4>
			    </div>
			    <div class="panel-body">
						<div class="form-group">
							<label for="id" class="col-sm-3 control-label"><span class="text-danger">*</span> 아이디<span class="rb-form-required"></span></label>
							<div class="col-sm-8">
