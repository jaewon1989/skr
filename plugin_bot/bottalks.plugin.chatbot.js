(function() {
    ...
    var d=new Date(), t=d.getFullYear()+""+(d.getMonth()+1)+""+d.getDate();
    var h=window.bottalksSetting.botHost, i=h+"/plugin_bot/bottalks.plugin.css?"+t;
    ...
    if (availableBrowser()) {
        ...
        window.addEventListener("message", function(ev) {
            if (ev.data.bottalks_use == true) {
                var bc = document.getElementById("bottalks-button-chat");
                bc.style.backgroundImage = "url('"+ev.data.btnChatbot+"')";
