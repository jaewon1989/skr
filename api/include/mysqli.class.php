...
define( 'DB_HOST', $DB['host'] ); // set database host
define( 'DB_USER', $DB['user'] ); // set database user
define( 'DB_PASS', $DB['pass'] ); // set database password
define( 'DB_NAME', $DB['name'] ); // set database name
