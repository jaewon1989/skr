...
function getErrorJSON($bResult, $bResultMsg="", $bResultData="") {
    ...
    include $g['path_core'].'function/botTemp.class.php';
    ...
    $_data = array();   	
   	...
   	$aResult = $BT->updateSysResource($_data);
   	print_r($aResult);
   	exit;
    ...
    if(!$targetBot) {
        ...
        /*
        // chatbot_channelSettings 입력
		setBotChannelSetting($vendor, $botid);

		//rb_chatbot_dialog
		$QKEY = "active, vendor, bot, graph, d_regis";
		$QVAL = "'1', '$vendor', '$lastBot', '', '$d_regis'";
		getDbInsert($table[$m.'dialog'],$QKEY,$QVAL);
		*/
