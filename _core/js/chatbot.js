...
$(function(){
    ...
    // 질문시작 시간 
    var get_Q_startTime = function(){
        var mtime = getMicrotime();
    ...
    var startTimer = function(){
       ContTimer.resetPlay();
       q_StartTime = get_Q_startTime(); // 질문 시작 시간 저장   
       console.log(q_StartTime);
    }
