	...
	e.cModal = function(t) {
		var n = {
			...
			u = {
				...
				_modalShow: function() {
					e("#chatBox-container").css({
						overflow: "hidden",
						width: e("#chatBox-container").innerWidth()
					}).append(o);
				},
				...
				_modalConent: function() {
					...
					t.type == "prompt" ? t.text = (t.text != null ? t.text : "") + '<input type="text" name="modal-prompt-input" class="modal-prompt-input" autocomplete="off" autofocus="on" placeholder="'+(t.placeholder ? t.placeholder : "")+'" />' : "";
					e(r).html(t.text);
					if (t.buttons || t.buttons != null) {
						...
						switch (t.type) {
							case "alert":
								...
								break;
							case "confirm":
								c = '<a class="modal-btn ' + (t.buttons[1] && t.buttons[1].addClass ? " " + t.buttons[1].addClass : "btn-black") + '">' + a.yes + '</a><a class="modal-btn' + (t.buttons[0].addClass ? " " + t.buttons[0].addClass : "") + '">' + a.cancel + '</a>';
								break;
							case "prompt":
								c = '<a class="modal-btn ' + (t.buttons[1] && t.buttons[1].addClass ? " " + t.buttons[1].addClass : "btn-black") + '">' + a.ok + '</a><a class="modal-btn' + (t.buttons[0].addClass ? " " + t.buttons[0].addClass : "") + '">' + a.cancel + '</a>';
								break;
							default:
